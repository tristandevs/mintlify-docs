...
<Tip>Note: Not all models are trained with tool calling data, only the following are capable of this feature: `shuttle-tools`, `gemini-pro`, `mixtral-8x7b`, `mistral-7b`, `gpt-3.5-turbo`, `gpt-4-0613`, `gpt-3.5-turbo-1106`, `gpt-3.5-turbo-0613`.</Tip>
